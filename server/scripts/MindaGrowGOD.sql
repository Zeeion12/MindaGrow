...
CREATE TABLE public.game_progress (
    ...
    last_played_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE public.games (
    ...
    total_questions integer DEFAULT 0,
    max_xp_reward integer DEFAULT 25,
...
--
-- Name: overall_rankings; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: overall_rankings_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.overall_rankings_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: overall_rankings_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.overall_rankings_id_seq OWNED BY public.overall_rankings.id;
...
CREATE TABLE public.submissions (
    ...
    CONSTRAINT chk_submission_status CHECK (((status)::text = ANY (ARRAY[('draft'::character varying)::text, ('submitted'::character varying)::text, ('graded'::character varying)::text, ('returned'::character varying)::text])))
);
...
CREATE TABLE public.user_game_progress (
    ...
    last_played_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    first_played_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT chk_completion_percentage CHECK (((completion_percentage >= (0)::numeric) AND (completion_percentage <= (100)::numeric)))
);
...
CREATE TABLE public.user_levels (
    ...
    CONSTRAINT chk_current_xp CHECK ((current_xp >= 0)),
...
CREATE TABLE public.user_streaks (
    ...
    last_game_played character varying(50),
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);
...
--
-- Name: weekly_rankings_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.weekly_rankings_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: weekly_rankings_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.weekly_rankings_id_seq OWNED BY public.weekly_rankings.id;
...
--
-- Name: overall_rankings id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.overall_rankings ALTER COLUMN id SET DEFAULT nextval('public.overall_rankings_id_seq'::regclass);
...
--
-- Name: weekly_rankings id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.weekly_rankings ALTER COLUMN id SET DEFAULT nextval('public.weekly_rankings_id_seq'::regclass);
...
INSERT INTO public.assignments (id, class_id, teacher_id, title, description, due_date, points, created_at, file_url, status, updated_at) VALUES (3, 1, 14, 'Membaca dan Memahami Teks Deskripsi', 'Kerjakan soal pada lampiran dibawah', '2025-07-19 23:00:00+07', 100, '2025-07-19 15:49:33.411186+07', 'uploads/assignments/assignment_1752914973363-171356404.pdf', 'active', '2025-07-19 15:49:33.411186+07');
...
INSERT INTO public.courses (id, title, description, thumbnail, price, level, duration, category_id, instructor_id, instructor_role, created_by, status, created_at, updated_at) VALUES (7, 'Sumber Daya Alam', 'Energi Terbarukan dirancang untuk memberikan pemahaman mendalam tentang bagaimana prinsip-prinsip biologi digunakan dalam pengembangan dan penerapan sumber energi ramah lingkungan. Fokus utama kursus ini adalah pada sumber energi yang berasal dari makhluk hidup atau proses biologis, seperti biomassa, biofuel, dan fotosintesis buatan.

1. Peserta akan mempelajari berbagai jenis energi terbarukan yang berkaitan langsung dengan proses biologis, termasuk:
2. Bioenergi: energi yang dihasilkan dari bahan organik seperti tanaman, limbah pertanian, dan kotoran hewan.
3. Biogas dan biofuel: hasil konversi bahan hayati menjadi bahan bakar cair atau gas, seperti etanol dan biodiesel.

Fotosintesis buatan: inovasi teknologi yang meniru proses alami tanaman dalam mengubah sinar matahari menjadi energi.

Melalui pendekatan interdisipliner yang menggabungkan biologi, ekologi, dan teknologi lingkungan, kursus ini juga membahas dampak ekologis dari penggunaan energi fosil dan urgensi peralihan ke sumber energi terbarukan yang lebih berkelanjutan.', NULL, 0.00, 'beginner', 60, 2, 13, 'guru', 13, 'active', '2025-07-14 10:36:56.266512', '2025-07-14 10:36:56.266512');
...
INSERT INTO public.daily_missions (id, mission_type, title, description, target_count, xp_reward, icon, is_active, created_at, target_value) VALUES (1, 'complete_quizzes', 'Complete 3 quizzes', 'Selesaikan 3 kuis hari ini dengan benar', 3, 50, '🧠', true, '2025-07-18 10:57:27.703719', 1);
INSERT INTO public.daily_missions (id, mission_type, title, description, target_count, xp_reward, icon, is_active, created_at, target_value) VALUES (4, 'play_game', 'Play any game', 'Mainkan game apapun hari ini', 1, 25, '🎮', true, '2025-07-18 10:57:27.703719', 1);
INSERT INTO public.daily_missions (id, mission_type, title, description, target_count, xp_reward, icon, is_active, created_at, target_value) VALUES (5, 'complete_quizzes', 'Complete 3 quizzes', 'Selesaikan 3 kuis hari ini dengan benar', 3, 50, '🧠', true, '2025-07-18 10:59:56.152864', 1);
INSERT INTO public.daily_missions (id, mission_type, title, description, target_count, xp_reward, icon, is_active, created_at, target_value) VALUES (8, 'play_game', 'Play any game', 'Mainkan game apapun hari ini', 1, 25, '🎮', true, '2025-07-18 10:59:56.152864', 1);
INSERT INTO public.daily_missions (id, mission_type, title, description, target_count, xp_reward, icon, is_active, created_at, target_value) VALUES (2, 'watch_videos', 'Watch 5 tutorial videos', 'Tonton 5 video pembelajaran untuk menambah wawasan', 5, 30, '📺', true, '2025-07-18 10:57:27.703719', 5);
INSERT INTO public.daily_missions (id, mission_type, title, description, target_count, xp_reward, icon, is_active, created_at, target_value) VALUES (6, 'watch_videos', 'Watch 5 tutorial videos', 'Tonton 5 video pembelajaran untuk menambah wawasan', 5, 30, '📺', true, '2025-07-18 10:59:56.152864', 5);
INSERT INTO public.daily_missions (id, mission_type, title, description, target_count, xp_reward, icon, is_active, created_at, target_value) VALUES (3, 'solve_problems', 'Solve 10 practice problems', 'Selesaikan 10 soal latihan dengan benar', 10, 100, '🧮', true, '2025-07-18 10:57:27.703719', 10);
INSERT INTO public.daily_missions (id, mission_type, title, description, target_count, xp_reward, icon, is_active, created_at, target_value) VALUES (7, 'solve_problems', 'Solve 10 practice problems', 'Selesaikan 10 soal latihan dengan benar', 10, 100, '🧮', true, '2025-07-18 10:59:56.152864', 10);
...
INSERT INTO public.enrollments (id, user_id, course_id, enrolled_at, status, completed_at) VALUES (5, 1, 7, '2025-07-14 10:37:41.948493', 'active', NULL);
...
INSERT INTO public.games (id, game_id, title, description, difficulty, total_questions, max_xp_reward, completion_bonus_xp, created_at, updated_at) VALUES (1, 'patternpuzzle', 'Tebak Pola (Pattern Puzzle)', 'Asah logika dengan menebak pola yang tersembunyi', 'Medium', 10, 25, 50, '2025-07-19 01:19:33.622228', '2025-07-19 01:19:33.622228');
INSERT INTO public.games (id, game_id, title, description, difficulty, total_questions, max_xp_reward, completion_bonus_xp, created_at, updated_at) VALUES (2, 'yesorno', 'Yes or No', 'Tes pengetahuan dengan pertanyaan ya atau tidak', 'Easy', 15, 20, 30, '2025-07-19 01:19:33.622228', '2025-07-19 01:19:33.622228');
INSERT INTO public.games (id, game_id, title, description, difficulty, total_questions, max_xp_reward, completion_bonus_xp, created_at, updated_at) VALUES (3, 'mazechallenge', 'Maze Challenge', 'Temukan jalan keluar dari labirin yang menantang', 'Hard', 4, 30, 75, '2025-07-19 01:19:33.622228', '2025-07-19 01:19:33.622228');
...
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (514, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-13 13:24:57.419115');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (515, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-13 13:25:42.783608');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (516, 'lintang.langitan@gmail.com', '::1', 'login', true, NULL, '2025-07-13 13:26:11.296337');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (517, 'lintang.langitan@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-13 13:26:19.37554');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (518, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-13 13:29:40.144484');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (519, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-13 13:29:50.508557');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (520, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-14 07:35:41.061205');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (521, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-14 07:35:52.205136');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (522, 'Budi@gmail.com', '::1', 'login', true, NULL, '2025-07-14 08:06:23.958507');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (523, 'Budi@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-14 08:06:36.572717');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (524, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-14 08:27:27.540328');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (525, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-14 08:27:37.379546');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (526, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-14 08:39:30.064546');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (527, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-14 08:41:17.399361');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (528, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-14 09:07:30.377404');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (529, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-14 09:07:34.739442');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (530, 'admin@platform.com', '::1', 'login', true, NULL, '2025-07-14 09:22:00.584898');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (531, 'admin@platform.com', '::1', '2fa_verify', true, NULL, '2025-07-14 09:22:16.060709');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (532, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-14 09:24:00.217526');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (533, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-14 09:24:07.951599');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (534, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-14 09:26:56.667374');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (535, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-14 09:27:09.933208');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (536, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-14 09:31:59.374193');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (537, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-14 09:32:05.996262');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (538, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-14 09:45:07.691845');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (539, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-14 09:45:17.480723');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (540, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-14 09:49:04.673814');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (541, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-14 09:49:17.45093');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (542, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-14 10:06:49.978805');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (543, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-14 10:07:00.44261');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (544, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-14 10:17:01.340462');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (545, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-14 10:17:06.058054');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (546, 'admin@platform.com', '::1', 'login', true, NULL, '2025-07-14 10:17:41.30395');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (547, 'admin@platform.com', '::1', '2fa_verify', true, NULL, '2025-07-14 10:17:48.239223');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (548, 'admin@platform.com', '::1', 'login', true, NULL, '2025-07-14 10:28:37.563374');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (549, 'admin@platform.com', '::1', '2fa_verify', true, NULL, '2025-07-14 10:28:48.060921');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (550, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-14 10:29:44.653931');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (551, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-14 10:29:55.455173');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (552, 'Budi@gmail.com', '::1', 'login', true, NULL, '2025-07-14 10:30:26.960384');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (553, 'Budi@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-14 10:30:34.419374');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (554, 'Budi@gmail.com', '::1', 'login', true, NULL, '2025-07-14 10:32:23.563311');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (555, 'Budi@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-14 10:32:29.330687');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (556, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-14 10:37:13.485645');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (557, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-14 10:37:18.680547');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (558, 'tejo@gmail.com', '::1', 'login', true, NULL, '2025-07-16 21:11:53.767748');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (559, '947200012', '::1', 'login', false, 'User not found', '2025-07-16 21:12:07.89981');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (560, 'tejo@gmail.com', '::1', 'login', true, NULL, '2025-07-16 21:12:11.414329');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (561, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-16 22:16:57.342531');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (562, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-16 22:17:10.373214');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (563, 'Budi@gmail.com', '::1', 'login', true, NULL, '2025-07-16 22:59:52.347416');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (564, 'tejo@gmail.com', '::1', 'login', false, 'Invalid password', '2025-07-16 23:00:26.284356');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (565, 'tejo@gmail.com', '::1', 'login', true, NULL, '2025-07-16 23:00:36.833516');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (566, 'tejo@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-16 23:00:45.47706');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (567, 'Budi@gmail.com', '::1', 'login', true, NULL, '2025-07-16 23:01:17.558909');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (568, 'Budi@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-16 23:01:29.308033');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (569, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-17 12:27:53.50794');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (570, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-17 12:28:04.004757');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (571, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-17 23:54:40.98276');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (572, 'dimasrizky822@gmail.com', '::1', '2fa_verify', false, 'Invalid 2FA token', '2025-07-17 23:55:04.367017');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (573, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-17 23:55:11.977416');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (574, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-18 09:51:10.135186');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (575, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-18 09:51:57.260098');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (576, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-18 09:59:20.047284');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (577, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-18 09:59:37.377903');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (578, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-18 10:02:47.968204');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (579, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-18 10:02:52.09983');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (580, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-18 10:12:27.6669');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (581, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-18 10:12:35.860657');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (582, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-18 10:20:31.492469');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (583, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-18 10:20:37.045992');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (584, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-18 10:22:31.506785');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (585, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-18 10:22:37.838466');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (586, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-18 10:32:16.102065');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (587, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-18 10:32:23.362627');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (588, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-18 10:44:37.476233');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (589, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-18 10:44:46.490715');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (590, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-18 11:03:29.990657');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (591, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-18 11:03:39.506189');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (592, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-18 11:07:28.198161');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (593, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-18 11:07:36.080506');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (594, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-18 11:08:51.277311');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (595, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-18 11:08:55.681595');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (596, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-18 11:11:47.413371');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (597, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-18 11:11:54.266684');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (598, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-18 14:12:58.954863');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (599, 'dimasrizky822@gmail.com', '::1', '2fa_verify', false, 'Invalid 2FA token', '2025-07-18 14:13:05.922014');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (600, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-18 14:13:11.502535');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (601, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-18 14:20:05.10439');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (602, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-18 14:20:09.88183');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (603, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-18 14:23:05.803839');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (604, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-18 14:23:11.377197');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (605, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-18 14:24:44.293997');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (606, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-18 14:24:50.812186');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (607, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-18 14:39:50.557339');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (608, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-18 14:40:05.584595');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (609, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-18 14:42:39.584357');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (610, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-18 14:42:45.159941');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (611, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-18 15:01:30.321015');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (612, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-18 15:01:38.907544');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (613, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-18 15:04:53.547961');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (614, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-18 15:04:57.4556');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (615, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-18 15:07:18.108001');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (616, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-18 15:07:21.636642');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (617, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-18 17:52:28.221858');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (618, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-18 17:52:41.452031');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (619, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-18 17:54:28.634474');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (620, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-18 17:54:37.400344');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (621, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 00:28:42.718725');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (622, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 00:28:53.145541');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (623, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 00:32:31.247185');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (624, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 00:32:40.382584');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (625, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 00:37:24.035062');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (626, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 00:37:28.890074');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (627, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 00:45:10.042777');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (628, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 00:45:17.407764');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (629, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 00:48:20.083859');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (630, 'dimasrizky822@gmail.com', '::1', '2fa_verify', false, 'Invalid 2FA token', '2025-07-19 00:48:27.566868');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (631, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 00:48:34.132341');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (632, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 01:00:33.131344');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (633, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 01:00:45.037499');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (634, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 01:23:01.850033');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (635, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 01:23:12.58425');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (636, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 02:09:59.836297');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (637, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 02:10:08.819526');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (638, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 02:22:11.015095');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (639, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 02:22:18.964523');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (640, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 02:29:36.391982');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (641, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 02:29:44.852953');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (642, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 02:37:31.605803');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (643, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 02:37:38.827472');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (644, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 02:51:10.285806');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (645, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 02:51:18.070352');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (646, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 03:01:14.192798');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (647, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 03:01:27.383463');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (648, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 03:10:25.724274');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (649, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 03:10:38.570274');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (650, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 03:16:11.901753');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (651, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 03:16:18.432615');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (652, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 03:17:58.272058');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (653, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 03:18:03.927939');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (654, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 03:19:16.256488');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (655, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 03:19:22.008714');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (656, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 03:28:07.871662');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (657, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 03:28:14.642284');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (658, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 03:30:01.016815');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (659, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 03:30:06.907808');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (660, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 03:31:40.592697');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (661, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 03:31:46.314816');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (662, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 03:39:25.857332');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (663, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 03:39:37.242717');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (664, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 03:57:22.940076');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (665, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 03:57:27.886902');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (666, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 04:06:13.488395');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (667, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 04:06:17.422754');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (668, 'lintang.langitan@gmail.com', '::1', 'login', true, NULL, '2025-07-19 04:08:16.105096');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (669, 'lintang.langitan@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 04:08:25.15599');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (670, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 04:18:34.351185');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (671, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 04:18:40.780385');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (672, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 04:33:05.749109');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (673, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 04:33:12.545863');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (674, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 04:39:08.8712');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (675, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 04:39:14.85217');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (676, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 04:43:49.81203');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (677, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 04:43:56.997809');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (678, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 04:46:55.138747');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (679, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 04:46:59.168642');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (680, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 05:05:51.342727');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (681, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 05:06:05.250663');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (682, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 05:06:50.024859');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (683, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 05:06:54.940367');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (684, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 05:16:16.699706');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (685, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 05:16:29.276731');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (686, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 05:18:11.031807');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (687, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 05:18:15.46728');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (688, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 05:20:01.665458');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (689, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 05:20:07.228675');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (690, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 10:46:15.260799');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (691, 'dimasrizky822@gmail.com', '::1', '2fa_verify', false, 'Invalid 2FA token', '2025-07-19 10:46:25.351877');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (692, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 10:46:33.450793');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (693, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 10:54:47.995348');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (694, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 10:54:52.548901');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (695, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 11:03:38.373695');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (696, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 11:03:43.486662');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (697, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 11:12:55.850015');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (698, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 11:13:06.383744');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (699, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 11:23:27.448575');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (700, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 11:23:34.554545');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (701, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 11:41:11.847026');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (702, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 11:41:16.77349');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (703, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 11:54:38.842167');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (704, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 11:54:44.477386');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (705, 'tejo@gmail.com', '::1', 'login', true, NULL, '2025-07-19 12:01:24.175446');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (706, 'tejo@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 12:01:28.404026');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (707, 'lintang.langitan@gmail.com', '::1', 'login', true, NULL, '2025-07-19 12:03:09.2583');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (708, 'lintang.langitan@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 12:03:14.861161');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (709, 'lintang.langitan@gmail.com', '::1', 'login', true, NULL, '2025-07-19 12:10:28.694366');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (710, 'lintang.langitan@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 12:10:33.267812');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (711, 'lintang.langitan@gmail.com', '::1', 'login', true, NULL, '2025-07-19 12:18:41.560076');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (712, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 12:18:51.51589');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (713, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 12:18:59.612917');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (714, 'tejo@gmail.com', '::1', 'login', true, NULL, '2025-07-19 12:22:23.440525');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (715, 'tejo@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 12:22:28.952646');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (716, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 12:44:27.583509');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (717, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 12:44:36.442433');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (718, 'dimasrizky822@gmail.com', '::1', 'login', true, NULL, '2025-07-19 12:57:48.201274');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (719, 'dimasrizky822@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 12:57:55.748392');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (720, 'tejo@gmail.com', '::1', 'login', true, NULL, '2025-07-19 12:58:04.068538');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (721, 'tejo@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 12:58:08.992965');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (722, 'tejo@gmail.com', '::1', 'login', true, NULL, '2025-07-19 15:05:27.739435');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (723, 'tejo@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 15:06:27.058824');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (724, 'nafis@gmail.com', '::1', 'login', true, NULL, '2025-07-19 15:40:10.0648');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (725, 'Siti.Amh123@gmail.com', '::1', 'login', true, NULL, '2025-07-19 15:43:58.137437');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (726, 'Siti.Amh123@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 15:44:19.944283');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (727, 'nafis@gmail.com', '::1', 'login', true, NULL, '2025-07-19 15:50:18.194591');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (728, 'nafis@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 15:50:42.330252');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (729, 'nafis@gmail.com', '::1', 'login', true, NULL, '2025-07-19 15:54:07.604172');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (730, 'nafis@gmail.com', '::1', '2fa_verify', true, NULL, '2025-07-19 15:54:37.936711');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (731, 'ayu@gmail.com', '::1', 'login', true, NULL, '2025-07-19 16:04:49.703877');
INSERT INTO public.login_attempts (id, email, ip_address, attempt_type, success, error_message, created_at) VALUES (732, 'khumaini@gmail.com', '::1', 'login', true, NULL, '2025-07-19 16:06:43.046386');
...
INSERT INTO public.orangtua (id, user_id, nik, nama_lengkap, no_telepon, registration_method) VALUES (5, 20, '1234567890123456', 'Khumaini', '08137368713', 'manual');


--
-- Data for Name: overall_rankings; Type: TABLE DATA; Schema: public; Owner: -
--
...
INSERT INTO public.user_game_progress (id, user_id, game_id, total_questions_answered, correct_answers, wrong_answers, completion_percentage, is_completed, total_xp_earned, best_score, times_played, last_played_at, first_played_at, created_at, updated_at) VALUES (1, 1, 'yesorno', 120, 108, 12, 100.00, true, 380, 93, 8, '2025-07-19 11:25:16.973573', '2025-07-19 01:24:22.371847', '2025-07-19 01:24:22.371847', '2025-07-19 11:25:16.973573');
INSERT INTO public.user_game_progress (id, user_id, game_id, total_questions_answered, correct_answers, wrong_answers, completion_percentage, is_completed, total_xp_earned, best_score, times_played, last_played_at, first_played_at, created_at, updated_at) VALUES (2, 18, 'yesorno', 45, 39, 6, 100.00, true, 141, 93, 3, '2025-07-19 12:04:52.065387', '2025-07-19 04:09:24.817829', '2025-07-19 04:09:24.817829', '2025-07-19 12:04:52.065387');
...
INSERT INTO public.user_levels (id, user_id, current_level, current_xp, total_xp, xp_to_next_level, created_at, updated_at) VALUES (1, 1, 6, 86, 380, 264, '2025-07-19 01:24:22.371847', '2025-07-19 11:25:16.973573');
INSERT INTO public.user_levels (id, user_id, current_level, current_xp, total_xp, xp_to_next_level, created_at, updated_at) VALUES (2, 18, 2, 89, 141, 19, '2025-07-19 04:09:24.817829', '2025-07-19 12:04:52.065387');
...
INSERT INTO public.user_sessions (id, user_id, session_token, refresh_token, ip_address, user_agent, expires_at, created_at, last_activity, is_active) VALUES (219, 1, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwicm9sZSI6InNpc3dhIiwiZW1haWwiOiJkaW1hc3Jpemt5ODIyQGdtYWlsLmNvbSIsImlhdCI6MTc1MjM4Nzk0MiwiZXhwIjoxNzUyNDc0MzQyfQ.aSLY06naHNCtso7fSnwcQUKEGPVkvA7Xf90-oK9NvCo', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36 Edg/138.0.0.0', '2025-07-14 13:25:42.785', '2025-07-13 13:25:42.786748', '2025-07-13 13:26:03.63691', false);
INSERT INTO public.user_sessions (id, user_id, session_token, refresh_token, ip_address, user_agent, expires_at, created_at, last_activity, is_active) VALUES (220, 18, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTgsInJvbGUiOiJzaXN3YSIsImVtYWlsIjoibGludGFuZy5sYW5naXRhbkBnbWFpbC5jb20iLCJpYXQiOjE3NTIzODc5NzksImV4cCI6MTc1MjQ3NDM3OX0.6U7qvpZ35ekm8vpy5Z8Lpbc1ned4LiZ1ZhTBK123Lh0', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36 Edg/138.0.0.0', '2025-07
 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6Nywicm9sZSI6Im9yYW5ndHVhIiwiZW1haWwiOiJ0ZWpvQGdtYWlsLmNvbSIsImlhdCI6MTc1MjkwNDY4OCwiZXhwIjoxNzUyOTkxMDg4fQ.s1DUhvrDDcTc1jUlPHE4lzCBJ1a0v2CDNrVxkSHkyx4', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36 Edg/138.0.0.0', '2025-07-20 12:58:08.987', '2025-07-19 12:58:08.994595', '2025-07-19 12:58:08.994595', true);
INSERT INTO public.user_sessions (id, user_id, session_token, refresh_token, ip_address, user_agent, expires_at, created_at, last_activity, is_active) VALUES (319, 7, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6Nywicm9sZSI6Im9yYW5ndHVhIiwiZW1haWwiOiJ0ZWpvQGdtYWlsLmNvbSIsImlhdCI6MTc1MjkxMjM4NywiZXhwIjoxNzUyOTk4Nzg3fQ.rA8DqoDAVOUXeC9AGa-bR8vh33ACyT6TG-X5n3rLfw8', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36 Edg/138.0.0.0', '2025-07-20 15:06:27.058', '2025-07-19 15:06:27.062368', '2025-07-19 15:39:56.733807', false);
INSERT INTO public.user_sessions (id, user_id, session_token, refresh_token, ip_address, user_agent, expires_at, created_at, last_activity, is_active) VALUES (320, 6, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6Niwicm9sZSI6InNpc3dhIiwiZW1haWwiOiJuYWZpc0BnbWFpbC5jb20iLCJpYXQiOjE3NTI5MTQ0NDksImV4cCI6MTc1MzAwMDg0OX0.JjiLSZGJkqvm-Sg-z8eQyZ9kwxwGgMZ8YedD2NOP8qQ', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36 Edg/138.0.0.0', '2025-07-20 15:40:49.202', '2025-07-19 15:40:49.203654', '2025-07-19 15:43:45.998316', false);
INSERT INTO public.user_sessions (id, user_id, session_token, refresh_token, ip_address, user_agent, expires_at, created_at, last_activity, is_active) VALUES (321, 14, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTQsInJvbGUiOiJndXJ1IiwiZW1haWwiOiJTaXRpLkFtaDEyM0BnbWFpbC5jb20iLCJpYXQiOjE3NTI5MTQ2NTksImV4cCI6MTc1MzAwMTA1OX0.laoJwXbyIFrkHIbCGCh1vEb_2atZZxL1m6N1CpP3hIQ', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36 Edg/138.0.0.0', '2025-07-20 15:44:19.947', '2025-07-19 15:44:19.948184', '2025-07-19 15:49:46.207439', false);
INSERT INTO public.user_sessions (id, user_id, session_token, refresh_token, ip_address, user_agent, expires_at, created_at, last_activity, is_active) VALUES (322, 6, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6Niwicm9sZSI6InNpc3dhIiwiZW1haWwiOiJuYWZpc0BnbWFpbC5jb20iLCJpYXQiOjE3NTI5MTUwNDIsImV4cCI6MTc1MzAwMTQ0Mn0.AGwtsstCpKa91tyMwji3PGKfwzIF_1lL7JTwx5RZQFY', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36 Edg/138.0.0.0', '2025-07-20 15:50:42.333', '2025-07-19 15:50:42.334087', '2025-07-19 15:50:42.334087', true);
INSERT INTO public.user_sessions (id, user_id, session_token, refresh_token, ip_address, user_agent, expires_at, created_at, last_activity, is_active) VALUES (323, 6, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6Niwicm9sZSI6InNpc3dhIiwiZW1haWwiOiJuYWZpc0BnbWFpbC5jb20iLCJpYXQiOjE3NTI5MTUyNzcsImV4cCI6MTc1MzAwMTY3N30.xpRRoLiBg7iPtUw48mTwxeOfN2BZRlPGPagx6XKNjgU', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36 Edg/138.0.0.0', '2025-07-20 15:54:37.934', '2025-07-19 15:54:37.940834', '2025-07-19 15:54:37.940834', true);
INSERT INTO public.user_sessions (id, user_id, session_token, refresh_token, ip_address, user_agent, expires_at, created_at, last_activity, is_active) VALUES (324, 20, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MjAsInJvbGUiOiJvcmFuZ3R1YSIsImVtYWlsIjoia2h1bWFpbmlAZ21haWwuY29tIiwiaWF0IjoxNzUyOTE2MDQ2LCJleHAiOjE3NTMwMDI0NDZ9.rK1Jz1WNbFVAfu_Y_v7KnKrixHAlke3H9aCNYETnTR4', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36 Edg/138.0.0.0', '2025-07-20 16:07:26.394', '2025-07-19 16:07:26.39952', '2025-07-19 16:11:16.005276', false);
...
INSERT INTO public.user_streaks (id, user_id, current_streak, longest_streak, is_active, last_activity_date, streak_start_date, last_game_played, created_at, updated_at) VALUES (2, 18, 2, 2, true, '2025-07-19', '2025-07-19', NULL, '2025-07-19 04:09:24.817829', '2025-07-19 12:04:52.065387');
INSERT INTO public.user_streaks (id, user_id, current_streak, longest_streak, is_active, last_activity_date, streak_start_date, last_game_played, created_at, updated_at) VALUES (1, 1, 2, 6, true, '2025-07-19', '2025-07-18', NULL, '2025-07-19 01:24:22.371847', '2025-07-19 11:25:16.973573');
...
INSERT INTO public.users (id, email, password, role, created_at, last_login, profile_picture, is_2fa_enabled, two_factor_secret, backup_codes, last_2fa_verify, google_id, oauth_provider, is_email_verified, avatar_url, role_selected, role_confirmation_date) VALUES (20, 'khumaini@gmail.com', '$2b$10$uLbtLNSi3BMIacSXtMQPwOHEgSpD8X00bFPJpQQaSirMn3GX.c/x2', 'orangtua', '2025-07-19 16:06:33.926873+07', '2025-07-19 16:07:26.389947+07', NULL, true, 'O5KWEUTSGJVUQULQO5KUE4TDEM2EKXTDHJRU4T3UPBEHKKSJLJVQ', NULL, NULL, NULL, NULL, false, NULL, false, NULL);
INSERT INTO public.users (id, email, password, role, created_at, last_login, profile_picture, is_2fa_enabled, two_factor_secret, backup_codes, last_2fa_verify, google_id, oauth_provider, is_email_verified, avatar_url, role_selected, role_confirmation_date) VALUES (2, 'tio@gmail.com', '$2b$10$7LULZ7RBZftd/M9t9zyJdu7ywx8qifCYEqMzuGp2l/oJ9Okqzm4fu', 'siswa', '2025-05-08 15:12:19.104442+07', '2025-07-11 17:55:39.242583+07', 'uploads/profile-pictures/profile_2_1751815244629.png', true, 'M5CUUUZ6HFQV26B6FFTXGOJMMRPHINCWHY4TSRKIJQYUWN3DKRFQ', NULL, '2025-07-10 07:41:12.962865', NULL, NULL, false, NULL, false, NULL);
INSERT INTO public.users (id, email, password, role, created_at, last_login, profile_picture, is_2fa_enabled, two_factor_secret, backup_codes, last_2fa_verify, google_id, oauth_provider, is_email_verified, avatar_url, role_selected, role_confirmation_date) VALUES (1, 'dimasrizky822@gmail.com', '$2b$10$3UaVMWehk2G7irXhlLw7I.9xnDXqIZqBzKRAhoTpr9IG/s73qW4hS', 'siswa', '2025-05-07 20:48:22.124923+07', '2025-07-19 12:57:55.746998+07', 'uploads/profile-pictures/profile_1_1750688863556.jpeg', true, 'JRKXEOSBJJFWINJPIA4CSQROIEXE2T3ZMV2X23JGMRYSMWRDMFYQ', NULL, '2025-07-19 12:57:55.746998', '106155532212043018420', 'google', true, 'https://lh3.googleusercontent.com/a/ACg8ocKOfZ_BLiD5Yh9w-fZP-DA6-bFUg-5oRiCpKT4Q4hNtJ2UwjtgV=s96-c', false, NULL);
INSERT INTO public.users (id, email, password, role, created_at, last_login, profile_picture, is_2fa_enabled, two_factor_secret, backup_codes, last_2fa_verify, google_id, oauth_provider, is_email_verified, avatar_url, role_selected, role_confirmation_date) VALUES (10, 'admin@platform.com', '$2b$10$Xfm.yJfMM9uY07efA8Zf9enI7JONqBVh89EtDe34pdhxuJ33SdHWu', 'admin', '2025-06-18 10:14:51.162478+07', '2025-07-14 10:28:48.059349+07', 'uploads/profile-pictures/profile_10_1750691161410.png', true, 'NN2EG4CAEE2CQXLVGF6WGYLGKJGCYWRWF4RXC63OHZRHAOB4LJKA', NULL, '2025-07-14 10:28:48.059349', NULL, NULL, false, NULL, false, NULL);
INSERT INTO public.users (id, email, password, role, created_at, last_login, profile_picture, is_2fa_enabled, two_factor_secret, backup_codes, last_2fa_verify, google_id, oauth_provider, is_email_verified, avatar_url, role_selected, role_confirmation_date) VALUES (7, 'tejo@gmail.com', '$2b$10$iDdH/7Jao9MUlVlw36jnGufSoslRYnklQXZS24MWh/ntntqteW8tO', 'orangtua', '2025-05-11 02:24:15.275135+07', '2025-07-19 15:06:27.056021+07', NULL, true, 'NRKWYUJJPJ2DUTBGHBHEMUKLOZAX23DPPVPESU2ELURWCZ25FBJA', NULL, '2025-07-19 15:06:27.056021', NULL, NULL, false, NULL, false, NULL);
INSERT INTO public.users (id, email, password, role, created_at, last_login, profile_picture, is_2fa_enabled, two_factor_secret, backup_codes, last_2fa_verify, google_id, oauth_provider, is_email_verified, avatar_url, role_selected, role_confirmation_date) VALUES (13, 'Budi@gmail.com', '$2b$10$LT.UfepEsjDdLsqOOiTMpe9t1./k7SWsbwkP1lDcxX4p4rbVBIoBu', 'guru', '2025-06-26 22:46:31.163405+07', '2025-07-16 23:01:29.305443+07', NULL, true, 'HBSSG2CUKVXCU6JPGVIFU5TVHZWHKILHLJHGKZSUFFDESYKCMJ4A', NULL, '2025-07-16 23:01:29.305443', NULL, NULL, false, NULL, false, NULL);
INSERT INTO public.users (id, email, password, role, created_at, last_login, profile_picture, is_2fa_enabled, two_factor_secret, backup_codes, last_2fa_verify, google_id, oauth_provider, is_email_verified, avatar_url, role_selected, role_confirmation_date) VALUES (18, 'lintang.langitan@gmail.com', '$2b$10$XP7mHnnqiG4Qswejk.MnX.YSuUfmivNMA1SXLtfrh5cPy3yXn033O', 'siswa', '2025-07-11 20:12:02.683229+07', '2025-07-19 12:18:41.556551+07', 'uploads/profile-pictures/profile_18_1752239765046.png', true, 'EVKFWLZXMJUE2RR6FJCUAVL5GZDH2233GZFTS22JFEZESYTUMU2A', NULL, '2025-07-19 12:10:33.263387', NULL, NULL, false, NULL, false, NULL);
INSERT INTO public.users (id, email, password, role, created_at, last_login, profile_picture, is_2fa_enabled, two_factor_secret, backup_codes, last_2fa_verify, google_id, oauth_provider, is_email_verified, avatar_url, role_selected, role_confirmation_date) VALUES (14, 'Siti.Amh123@gmail.com', '$2b$10$uXPVa/lQuEbZs3RR8naQReGdN2sfNeuxoROdu/qK1INRLVC6JvXxK', 'guru', '2025-07-06 23:10:42.212824+07', '2025-07-19 15:44:19.942034+07', NULL, true, 'INZE6UTSFQUWCR3LKQXT6QZONVNE6KSCLZYVONKDN4VEM3J2OBVQ', NULL, '2025-07-19 15:44:19.942034', NULL, NULL, false, NULL, false, NULL);
INSERT INTO public.users (id, email, password, role, created_at, last_login, profile_picture, is_2fa_enabled, two_factor_secret, backup_codes, last_2fa_verify, google_id, oauth_provider, is_email_verified, avatar_url, role_selected, role_confirmation_date) VALUES (6, 'nafis@gmail.com', '$2b$10$Q4Vuf/yYl6SOisWi5fP7yu32E1PTfO0UNnzp87aKKKGBi/Vg03AyK', 'siswa', '2025-05-11 02:21:14.196755+07', '2025-07-19 15:54:37.934519+07', NULL, true, 'NYVHO6TPHJKFUS3MFFIC4USJIZ2VO42NGNUT4LR6GVFFOVJTHZ4A', NULL, '2025-07-19 15:54:37.934519', NULL, NULL, false, NULL, false, NULL);
INSERT INTO public.users (id, email, password, role, created_at, last_login, profile_picture, is_2fa_enabled, two_factor_secret, backup_codes, last_2fa_verify, google_id, oauth_provider, is_email_verified, avatar_url, role_selected, role_confirmation_date) VALUES (4, 'ayu@gmail.com', '$2b$10$2rqlr.KsFu.7pe7qVuiwu.QTKmyefcVLc9mTFZpy7MiM0WI/0X1hC', 'orangtua', '2025-05-09 11:21:33.881021+07', '2025-07-19 16:04:49.695755+07', NULL, true, 'FY5HEI35EN6XONJYM5TFIW2AFE3HI2LZKRJHQZ2QMVNUCTK6EZGA', NULL, NULL, NULL, NULL, false, NULL, false, NULL);


--
-- Data for Name: weekly_rankings; Type: TABLE DATA; Schema: public; Owner: -
--
...
SELECT pg_catalog.setval('public.daily_missions_id_seq', 8, true);
...
SELECT pg_catalog.setval('public.login_attempts_id_seq', 732, true);
...
SELECT pg_catalog.setval('public.orangtua_id_seq', 5, true);


--
-- Name: overall_rankings_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.overall_rankings_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.temp_2fa_tokens_id_seq', 37, true);
...
SELECT pg_catalog.setval('public.user_daily_missions_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.user_game_progress_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.user_levels_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.user_sessions_id_seq', 324, true);
...
--
-- Name: weekly_rankings_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.weekly_rankings_id_seq', 1, false);
...
--
-- Name: game_progress game_progress_user_id_game_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.game_progress
    ADD CONSTRAINT game_progress_user_id_game_id_key UNIQUE (user_id, game_id);
...
--
-- Name: overall_rankings overall_rankings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.overall_rankings
    ADD CONSTRAINT overall_rankings_pkey PRIMARY KEY (id);
...
--
-- Name: submissions unique_submission; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_game_progress unique_user_game; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_levels unique_user_level; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: overall_rankings unique_user_overall; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.overall_rankings
    ADD CONSTRAINT unique_user_overall UNIQUE (user_id);
...
--
-- Name: weekly_rankings weekly_rankings_user_id_week_start_date_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.weekly_rankings
    ADD CONSTRAINT weekly_rankings_user_id_week_start_date_key UNIQUE (user_id, week_start_date);
...
--
-- Name: idx_overall_rankings_user; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_overall_rankings_user ON public.overall_rankings USING btree (user_id);
...
--
-- Name: idx_user_game_progress_game; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_user_game_progress_game ON public.user_game_progress USING btree (game_id);


--
-- Name: idx_user_game_progress_user; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_user_game_progress_user ON public.user_game_progress USING btree (user_id);


--
-- Name: idx_user_levels_user; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_weekly_rankings_user; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_weekly_rankings_user ON public.weekly_rankings USING btree (user_id);
...
--
-- Name: overall_rankings overall_rankings_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.overall_rankings
    ADD CONSTRAINT overall_rankings_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.user_game_progress
    ADD CONSTRAINT user_game_progress_game_id_fkey FOREIGN KEY (game_id) REFERENCES public.games(game_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.weekly_rankings
    ADD CONSTRAINT weekly_rankings_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
