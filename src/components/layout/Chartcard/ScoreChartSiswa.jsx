...
const subjectScores = [
    { subject: "Matematika", score: 78, color: "#3b82f6" },
    { subject: "Bahasa Indonesia", score: 85, color: "#10b981" },
    { subject: "Bahasa Inggris", score: 72, color: "#f59e0b" },
    { subject: "IPA", score: 80, color: "#8b5cf6" },
    { subject: "IPS", score: 76, color: "#ec4899" },
    { subject: "Seni dan Kerajinan", score: 90, color: "#06b6d4" },
    { subject: "Pendidikan Jasmani", score: 88, color: "#84cc16" },
]
